...
export default function Contact({ params }: { params: { locale: Locale } }) {
  ...
  // Sadece "tr" locale için bu sayfayı göster, "en" için contact sayfasına yönlendir
  if (locale === 'en') {
    notFound();
  }
    ...
    <main className="pt-32 pb-20 bg-gray-50">
      <Container>
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4 text-gray-800">İletişim</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Herhangi bir sorunuz veya talebiniz için bizimle iletişime geçebilirsiniz. En kısa sürede size geri dönüş yapacağız.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-xl shadow-sm p-8 transition-all hover:shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{CONTACT_INFO.address.tr}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 transition-all hover:shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">{t('phoneNumber')}</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 transition-all hover:shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800">{t('emailAddress')}</h3>
                  <p className="text-gray-600">
          ...
          {/* Google Maps ve Logo Alanı */}
          <div className="lg:col-span-3">
            <div className="bg-white p-4 rounded-xl shadow-sm h-full flex flex-col gap-4">
              {/* Google Maps Embed */}
              <div className="w-full h-[400px] rounded-xl overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&q=Gülbahar,+Avni+Dilligil+Sk.+No:5,+34394+Şişli/İstanbul&center=41.0685418,29.0016467&zoom=20.5"  
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
